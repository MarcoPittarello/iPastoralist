...
#' @param SpeAbund object generated from \link[iPastoralist]{first_ten_species}.
#' @param dbClust matrix used for the computation of surveys' distance matrix (e.g. with either \link[amap]{Dist} or \link[vegan]{vegdist}). This matrix has surveys as rows and species as columns.
