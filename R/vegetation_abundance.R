...
#' @param method * **"SRA_fo"**: SRA calculated from FO without occasional species.see \href{https://raw.githubusercontent.com/MarcoPittarello/iPastoralist/main/man/figures/Wrkflw_abundance_conversion.png}{MarcoPittarello/iPastoralist} for a full graphical explanation
#' * **"SC_fo"**: %SC calculated by multiplying FO for a coefficient so that the number of total measurements along the transect line refer to 100 (occasional species are excluded). see \href{https://raw.githubusercontent.com/MarcoPittarello/iPastoralist/main/man/figures/Wrkflw_abundance_conversion.png}{MarcoPittarello/iPastoralist} for a full graphical explanation
#' * **"SC_fo_occ"**: like SC_fo but with in addition the occasional species, considered as 0.3%. The total %SC  per each surveys will be > 100 %. see \href{https://raw.githubusercontent.com/MarcoPittarello/iPastoralist/main/man/figures/Wrkflw_abundance_conversion.png}{MarcoPittarello/iPastoralist} for a full graphical explanation
#' * **"SRA_SC.fo.occ"**: SRA calculated from SC_fo_occ, i.e. rescale SC_fo_occ so that the total sum per each survey sum up to 100 %. see \href{https://raw.githubusercontent.com/MarcoPittarello/iPastoralist/main/man/figures/Wrkflw_abundance_conversion.png}{MarcoPittarello/iPastoralist} for a full graphical explanation
...
vegetation_abundance<-function(database,method,species.cover.coefficient){
  options(max.print=50E5) ## per esportare output di grandi dimensioni
  veg1<-database
